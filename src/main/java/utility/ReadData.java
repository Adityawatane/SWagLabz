...
public class ReadData 
{
	...
	public static String readPropertyFile(String value) throws IOException {
		...
		FileInputStream file =new FileInputStream("E:\\NTC\\Eclipse\\Project_Selenium\\TestData\\config.properties");
		prop.load(file);
	...
	{
		FileInputStream file=new FileInputStream("E:\\NTC\\Eclipse\\Project_Selenium\\TestData\\Book1.xlsx");
